...
def main(argv):
    ...
    out1 = outputdir + "/ctg-cellranger-rna-count-summary_metrics.csv"
    out2 = outputdir + "/cellranger-rna-count_summary_metrics_mqc.csv"
    ...
    f.write("# section_name: 'Cellranger Metrics (RNA)'\n")
    f.write("# description: 'Cellranger 10x-sc-adt-rna count metrics for RNA libraries'\n")
    f.write("# pconfig:\n")
